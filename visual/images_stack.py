...
# 设置图片所在目录和输出大图的文件名
image_folder = r"D:\Code\Social_segregation\data\Jaccard_similarity_OHSA_with_city_name"  # 修改为你的文件夹路径
output_image_path = r"D:/Code/Social_segregation/OHSA_merged_heatmap_with_city_name.png"
