...
for level in confidence_levels:
    for t in types:
        ...
        # Create a copy of the dataframe with renamed index and columns
        df_renamed = similarity_data[level][t].astype(float).copy()
        ...
        sns.heatmap(df_renamed, annot=True, cmap="coolwarm", linewidths=0.5, vmin=0, vmax=0.3)
